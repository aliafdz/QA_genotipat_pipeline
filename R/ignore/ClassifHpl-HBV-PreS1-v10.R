...
# MACHpl02.AB2774.HBV.2822.3296.fna
flnms <- dir(hplDir,"MACHpl02.+\\.HBV\\.2822\\.3296\\.fna$")  
...
gen.nm <- tit <- c("HBV_RefSeqs_2844_3276")
...
pdf.flnm <- file.path(resultsDir,"HBV_2844_3276_HplGenotyping.pdf")
...
sink(file.path(resultsDir,"HBV_2844_3276_HplGenotypingRprt.txt"))
...
sink(file.path(resultsDir,"HBV_2844_3276_HplGenotyping_SummaryRprt.txt"))
cat("\n   GENOTYPING HBV CONSENSUS HAPLOTYPES")
cat("\n=========================================\n")
cat("\n Results of discriminant analysis by the DB rule:\n\n")
cat("\n\nCoverage by patient:\n")
...
pdf.flnm <- file.path(resultsDir,'HBV_2844_3276_GenotypingBarplot.pdf')
...
pdf.flnm <- file.path(resultsDir,'HBV_2844_3276_HplGenotypingConfidence.pdf')
pdf(pdf.flnm,paper='a4',width=7,height=6)
print(P)
dev.off()
...
save(covs,res,res.dst,gtbl,gtbl2,df.gtbl,df.gtbl2,
     file=file.path(resultsDir,"PreS1_Classif.RData"))
